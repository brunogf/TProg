...
public class Reserva {
    ...
    public DataReserva infoReservaProveedorPublicacion(String proveedor, String publicacion) {
        Set<ParDPD> conjDPD = new HashSet<>();
        for (ReservaPublicacion rp : rp_) {
    ...
    public DataReserva infoReservaProveedor(String nick) {
        Set<ParDPD> conjDPD = new HashSet<>();
        for (ReservaPublicacion rp : rp_) {
            ParDPD dpd = rp.infoReservaPorProveedor(nick);
            if (dpd!=null){
            conjDPD.add(dpd);
            }
        }
